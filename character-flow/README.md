...
Normal text → routes through swordcli proxy to your LLM model with Izuku persona + BM25 context.
...
Normal text → routes through swordcli proxy with Mahina persona + her BM25 context.

---

## Shared Infrastructure

- **swordcli** (port 3001): OpenAI-compatible proxy + `/api/character/*` endpoints
