...
import type { ChatMessage, ChatToolCall, ChatToolDefinition } from '@swordcli/shared/types.js';
...
export const DEFAULT_SYSTEM_PROMPT = [
  'You are SwordCLI\'s coding agent. You work inside a single sandboxed working directory (the session workdir).',
